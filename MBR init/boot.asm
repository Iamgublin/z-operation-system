...
printenter:
		...
		mov ah,02h 
		int 21h
do_print_message_loop1:        
        lodsb
        test al,al
        jz do_print_message_done1
		test al,'x'
		je printenter
        int 0x10
        jmp do_print_message_loop1

do_print_message_done1:        
        popa
        ret
;--------------------------
; dot(): 打印点
...
hello db 'welcome to enter zlz operation system', 0, 0, 0
read_sector_failure     db ''
%ifdef UBOOT
                        db ''
%else
                        db ''
